...
//       context.read<BookmarkMapCubit>().loadBookmarkMapFilter(
...
//   Widget bottomSheet(Bookmark store, String memberId) {
...
//   void MarkUp(List<Bookmark> storeList, BuildContext context) async {
